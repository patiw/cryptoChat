...
def tripledes_encrypt(m, key)
  ...
  keys_a = expand(key_a)
  keys_b = expand(key_b)
  c = des_encrypt(m, keys_a) #Use first key
...
k3d = '00000000 00100010 00111111 01011100 01010101 01100110 01110111 10001001
       10000111 10011000 01111001 01000101 00110101 00100001 00110101 01000100'.to_bits
m3d = "succ\nit"
#original message
puts m3d
#converting \n to separate chars
m3d = m3d.delete_end_lines.to_bytes.to_bits
#puts formated text
puts m3d.blocks(8).to_text
#encrypt
e = tripledes_encrypt(m3d,k3d)
puts e.blocks(8).to_text
#decrypt
d = tripledes_decrypt(e,k3d)
#format encrypted text and change "\" "n" to "\n" used in strings
d = d.blocks(8).to_text.recover_end_lines
puts d
